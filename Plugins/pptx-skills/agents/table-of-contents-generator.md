...
7. **Page number badge** — **MANDATORY**. Place the current slide index number in the bottom-right corner. The badge style should be consistent with the overall presentation design.
