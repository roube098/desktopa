...
### 3. Investment research / institutional cover

- **Look**: Restrained, authoritative; often dark navy or charcoal band or full-bleed dark footer; plenty of white or off-white.
- **Content**: Report title (company/asset/theme), subtitle such as “Investment research” or “Confidential”, date, firm or author line.
- **Avoid**: Stock hero photos unless user supplied; flashy gradients; marketing taglines.
- Read **investment-research-skill** when the deck is research-style.
- Example structure:
  ```
  |                                        |
  |           [Background Image]           |
