...
const TABS: Tab[] = [
    ...
    },
    {
        ...
        icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l3 3-3 3-3-3 3-3z" /><path d="M5 9l3 3-3 3-3-3 3-3z" /><path d="M19 9l3 3-3 3-3-3 3-3z" /><path d="M12 16l3 3-3 3-3-3 3-3z" /></svg>,
    },
    {
